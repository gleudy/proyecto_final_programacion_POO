...
public class Home extends JFrame {
	...
	private JTextField txtClienteTipo;
	...
	public Home() {
		...
		panel_4.setBounds(89, 43, 693, 522);
		panel_3.add(panel_4);
		...
		txtClienteNombre.setBounds(348, 50, 313, 30);
		...
		txtClienteDireccion.setBounds(348, 134, 313, 49);
		...
		txtClienteTipo = new JTextField();
		txtClienteTipo.setColumns(10);
		txtClienteTipo.setBounds(31, 216, 234, 30);
		panel_4.add(txtClienteTipo);
		
		JButton btnGuardarCliente = new JButton("Guardar");
		btnGuardarCliente.setForeground(new Color(255, 255, 255));
		btnGuardarCliente.setBackground(new Color(0, 0, 255));
		btnGuardarCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        String tipoCliente = txtClienteTipo.getText();

		        // Crear un nuevo objeto Cliente con los datos ingresados por el usuario
		        Cliente nuevoCliente = new Cliente(cedula, nombre, direccion, telefono, tipoCliente);
			    ...
			    if (clientes != null) {
			        ...
			        for (Object obj : clientes) {
			            if (obj instanceof Cliente) {
			                ...
			                modelClientes.addRow(new Object[]{cliente.getCedula(), cliente.getNombre(), cliente.getDireccion(), cliente.getTelefono(), cliente.getTipoCliente()});
			            }
			        }
			    }
			}
		});
		btnGuardarCliente.setFont(new Font("Tahoma", Font.BOLD, 16));
		btnGuardarCliente.setBounds(348, 194, 313, 49);
		panel_4.add(btnGuardarCliente);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(31, 270, 630, 241);
		...
		if (clientes != null) {
		    for (Object obj : clientes) {
		        if (obj instanceof Cliente) {
		            Cliente cliente = (Cliente) obj;
		            model.addRow(new Object[]{cliente.getCedula(), cliente.getNombre(), cliente.getTelefono(), cliente.getDireccion(), cliente.getTipoCliente()});
		        }
		    }
		}
		...
		btnGuardarTrabajador.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        // Formatear la fecha actual como String (puedes ajustar el formato según lo necesites)
		     

		        // Obtener los otros datos ingresados por el usuario desde los campos de texto u otros componentes
		        ...
		        // Verificar si la lista de empleados es nula y, si es así, crear una nueva lista
		        if (empleados == null) {
			    ...
			    if (empleados != null) {
			        ...
			        for (Object obj : empleados) {
			            if (obj instanceof Empleado) {
			                ...
			                modelTrabajadores.addRow(new Object[]{empleado.getCedula(), empleado.getNombre(), empleado.getDireccion(), empleado.getTelefono(), empleado.getFechaIngreso(), empleado.getCargo(), empleado.getSueldo()});
			            }
			        }
			    }
			}
		...
		btnGuardarRam.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 String id = txtRamNum.getText();
			        ...
			        // Verificar si la lista de componentes es nula y, si es así, crear una nueva lista
			        if (componentes == null) {
			    ...
			    if (componentes != null) {
			        ...
			        for (Object obj : componentes) {
			            if (obj instanceof Ram) {
			                Ram ram = (Ram) obj;
			                modelRam.addRow(new Object[]{ram.getNumeroSerie(), ram.getPrecio(), ram.getCantidadDispo(), ram.getMarca(), ram.getCantMemoria(), ram.getTipoMemoria()});
			            }
			        }
			    }
			}
		...
		brnDiscoGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Obtener los datos ingresados por el usuario desde los campos de texto u otros componentes
			    ...
			    if (componentes != null) {
			        ...
			        for (Object obj : componentes) {
			            if (obj instanceof Disco) {
			                ...
			                modelDisco.addRow(new Object[]{disco.getNumeroSerie(), disco.getPrecio(), disco.getCantidadDispo(), disco.getMarca(), disco.getModelo(), disco.getAlmacenamiento(), disco.getTipoConexion()});
			            }
			        }
			    }
			}
		...
		if (componentes1 != null) {
		    // Recorrer la lista de componentes y agregar los discos duros al modelo de la tabla
		...
		btnMicroGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        // Crear un nuevo objeto Disco con los datos ingresados por el usuario
		        Micro nuevoMicro = new Micro(id, precio, cantidad, marca, modelo, tipoConexion,
		    			velocidad);
			    ...
			    if (componentes != null) {
			        ...
			        for (Object obj : componentes) {
			            if (obj instanceof Micro) {
			                ...
			                modelMicro.addRow(new Object[]{micro.getNumeroSerie(), micro.getPrecio(), micro.getCantidadDispo(), micro.getMarca(), micro.getModelo(), micro.getVelocidadProc(), micro.getTipoConexion()});
			            }
			        }
			    }
		...
		btnMotherGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        // Crear un nuevo objeto Disco con los datos ingresados por el usuario
		        MotherBoard nuevoMother = new MotherBoard(id, precio, cantidad, marca, modelo, tipoConector,
		    			conexiones,tipoRam);
			    ...
			    if (componentes != null) {
			        ...
			        for (Object obj : componentes) {
			            if (obj instanceof MotherBoard) {
			                ...
			                modelMother.addRow(new Object[]{mother.getNumeroSerie(), mother.getPrecio(), mother.getCantidadDispo(), mother.getMarca(), mother.getModelo(), mother.getTipoRam(), mother.getTipoConector(), mother.getConexiones()});
			            }
			        }
			    }
